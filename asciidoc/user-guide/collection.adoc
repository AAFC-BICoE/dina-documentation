[id=collection]
== Collection
A Collection represents the top entity that can contain material-sample. For more information about Collections, please refer to https://aafc-bicoe.github.io/dina-documentation/#collection[AAFC-BICoE DINA User Guide - Collection].
