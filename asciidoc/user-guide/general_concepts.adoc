...
Check out the <<split>> section for more information on Material Sample splits.
...
When editing a form template, you can enable the split configuration in the Data Component sidebar by toggling the switch.

After enabling it, you will see a Split Configuration section added at the top of the page.
