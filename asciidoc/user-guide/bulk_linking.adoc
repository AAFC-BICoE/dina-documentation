...
image::bulk-linking/DataComponents.png[align="center"]

[start=6]
. In the Material Sample Attachments section, click the `Add Attachments` button.

image::bulk-linking/AddAttachments.png[align="center"]
...
image::bulk-linking/AttachSelected.png[align="center"]
...
image::bulk-linking/Save.png[align="center"]
