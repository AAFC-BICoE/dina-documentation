...
image::persons/Homepage.png[align="center"]

[start=2]
. In the Persons page, click on the `Create New` button.

image::persons/CreateNew.png[align="center"]
...
image::persons/ListPage.png[align="center"]
...
image::persons/Collectors.png[align="center"]
