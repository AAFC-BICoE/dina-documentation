...
Preparation can either be for preservation or multiplication purpose.

[[preparation-type]]
=== Preparation Type

A noun representing the what is prepared.
...
A noun representing the how the material sample is prepared.
