...
Primary identifier that is preferably globaly unique and human readable. When creating a new record, best pratice is to use collection code as prefix to allow the record to be referenceable outside the collection.
