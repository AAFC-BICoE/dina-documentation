...
Host of the material-sample at the time of the collecting-event. The collecting-event host is mostly an observation since no physical evidence is collected.
