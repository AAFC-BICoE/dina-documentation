...
Using that strategy, the generated children will get the next name available among the complete set of material sample of type in the entire lineage.
