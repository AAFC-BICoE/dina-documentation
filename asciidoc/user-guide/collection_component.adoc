...
[options="header"]
.Split Series Options
|============================================================================
| Split From  | Children of ABC-01  | Series Option                | Result  
| ABC-01      |                     | New Series                   | ABC-01-A
| ABC-01      | ABC-01-A            | Continue Series              | ABC-01-B
| ABC-01-A    | ABC-01-A, ABC-01-B  | Continue Series from Parent  | ABC-01-C
|============================================================================
...
Only for reporting and record keeping purposes. No real actions will be taken on assigned date. Multiple actions can exist, and each action can be edited or deleted.
