...
image::object-store/Homepage.png[]
...
image::object-store/1-ListPage.png[]

[start=7]
. In the sample's view page, click on the `Edit` button.

image::object-store/Edit.png[]
...
image::object-store/AddAttachments.png[]
...
image::object-store/Attachments.png[]
...
image::object-store/LastSave.png[]
...
image::object-store/SaveUpload.png[]
