...
IMPORTANT: If you are planning to use the object-store, make sure the group names are following [https://docs.aws.amazon.com/AmazonS3/latest/userguide/bucketnamingrules.htmls3 bucket naming rules]¸
