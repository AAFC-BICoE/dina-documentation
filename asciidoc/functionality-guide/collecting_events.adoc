[id=collectingEvents]
== Collecting Events
A Collecting Event is the event of extraction from nature. For more information regarding Collecting Events, please refer to https://aafc-bicoe.github.io/dina-documentation/#collecting-event[AAFC-BICoE DINA User Guide - Collecting Event].
